...
def generate_image(title, top_text, author, image_code, theme, guide_text_placement, guide_text):
    theme_colors = {
        "0": (85, 19, 93, 255),   # Dark Purple
        "1": (113, 112, 110, 255),   # Gray
        "2": (128, 27, 42, 255),   # Dark Red
        "3": (184, 7, 33, 255),   # Crimson
        "4": (101, 22, 28, 255),   # Maroon
        "5": (80, 61, 189, 255),   # Royal Blue
        "6": (225, 17, 5, 255),   # Bright Red
        "7": (6, 123, 176, 255),   # Cyan
        "8": (247, 181, 0, 255),   # Golden Yellow
        "9": (0, 15, 118, 255),   # Navy Blue
        "10": (168, 0, 155, 255),   # Purple
        "11": (0, 132, 69, 255),   # Forest Green
        "12": (0, 153, 157, 255),   # Teal
        "13": (1, 66, 132, 255),   # Dark Blue
        "14": (177, 0, 52, 255),   # Burgundy
        "15": (55, 142, 25, 255),   # Green
        "16": (133, 152, 0, 255),    # Olive
        "17": (36, 161, 222, 255)    # Light Blue
    }
